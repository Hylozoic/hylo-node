...
const MobileAppController = require(root(
  "api/controllers/MobileAppController"
));
...
describe("MobileAppController", () => {
  let req, res, tmpVar1, tmpVar2, tmpVar3;
  beforeEach(() => {
  ...
  describe("checkShouldUpdate", () => {
    it("returns the expected object for ios suggest update", () => {
      const expected = {
        ...
        message:
          "The version you are using is no longer up to date. Please go to the App Store to update.",
    ...
    it("returns the expected object for ios force update", () => {
      const expected = {
        ...
        title: "A new version of the app is available",
        message:
          "The version you are using is no longer supported. Please go to the App Store now to update.",
        link: mockIosStoreUrl,
      };
    ...
    it("returns the expected object for android suggest update", () => {
      const expected = {
        ...
        title: "An update is available",
        message:
          "The version you are using is no longer up to date. Please go to the Play Store to update.",
    ...
    it("returns the expected object for android force update", () => {
      const expected = {
        ...
        title: "A new version of the app is available",
        message:
          "The version you are using is no longer supported. Please go to the Play Store now to update.",
        link: mockAndroidStoreUrl,
      };
