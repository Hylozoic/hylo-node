...
const testImageUrl =
  "http://cdn.hylo.com/misc/hylo-logo-teal-on-transparent.png";
const testImageUrl2 =
  "http://cdn.hylo.com/misc/hylo-logo-white-on-teal-circle.png";
  ...
  describe(".createFromEmailForm", () => {
    ...
    describe("for an inactive community", () => {
      ...
      it("does not work", () => {
        ...
        return PostController.createFromEmailForm(req, res).then(() => {
