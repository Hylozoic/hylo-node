...
import { myNetworkCommunityIdsSqlFragment } from "../../../api/models/util/queryFilters.test.helpers";

describe("Network", () => {
  describe(".activeCommunityIds", () => {
    it("generates correct SQL", () => {
      expectEqualQuery(
        Network.activeCommunityIds("42", true),
        myNetworkCommunityIdsSqlFragment("42", { parens: false }),
        { isCollection: false }
      );
    });
  });
