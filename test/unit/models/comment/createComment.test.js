import { pushMessageToSockets } from "../../../../api/models/comment/createComment";
import { createThread } from "../../../../api/models/post/findOrCreateThread";
...
describe("comment/createComment", () => {
  ...
  describe("pushMessageToSockets", () => {
    ...
    it("sends newThread event if first message", () => {
      ...
      return pushMessageToSockets(message, thread).then((promises) => {
