...
describe("Community", () => {
  ...
  describe(".isSlugValid", () => {
    it("rejects invalid slugs", () => {
      ...
      expect(Community.isSlugValid("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdx"))
        .to.be.false;
    });
  });
  ...
  describe(".deactivate", () => {
    ...
    it("sets active to false and calls Group.deactivate", async () => {
      ...
      expect(Group.deactivate).to.have.been.called.with(
        community.id,
        Community
      );
    });
