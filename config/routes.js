...
module.exports.routes = {
  ...
  "GET    /noo/hook/batchCommentForm":
    "CommentController.createBatchFromEmailForm",
  "POST   /noo/hook/batchCommentForm":
    "CommentController.createBatchFromEmailForm",
  ...
  "GET    /noo/login/facebook-token/oauth":
    "SessionController.finishFacebookTokenOAuth",
  "POST   /noo/login/facebook-token/oauth":
    "SessionController.finishFacebookTokenOAuth",
  "GET    /noo/login/google-token/oauth":
    "SessionController.finishGoogleTokenOAuth",
  "POST   /noo/login/google-token/oauth":
    "SessionController.finishGoogleTokenOAuth",
  "GET    /noo/login/linkedin-token/oauth":
    "SessionController.finishLinkedinTokenOAuth",
  "POST   /noo/login/linkedin-token/oauth":
    "SessionController.finishLinkedinTokenOAuth",
  ...
  "GET     /noo/mobile/check-should-update":
    "MobileAppController.checkShouldUpdate",
  ...
  // websockets routes
  "POST   /noo/community/:communityId/subscribe":
    "CommunityController.subscribe",
  "POST   /noo/community/:communityId/unsubscribe":
