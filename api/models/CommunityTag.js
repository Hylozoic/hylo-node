...
module.exports = bookshelf.Model.extend(
  {
    ...
    postCount: function () {
      return CommunityTag.taggedPostCount(
    ...
    followerCount: function () {
      return Tag.followersCount(this.get("tag_id"), {
        communityId: this.get("community_id"),
      });
    },

    consolidateFollowerCount: function () {
      return this.followerCount().then((num_followers) => {
        if (num_followers === this.get("num_followers"))
  ...
  },
  {
    create(attrs, { transacting } = {}) {
      return this.forge(
        Object.assign({ created_at: new Date(), updated_at: new Date() }, attrs)
      ).save({}, { transacting });
    },
