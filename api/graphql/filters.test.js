...
import {
  myCommunityIdsSqlFragment,
  myNetworkCommunityIdsSqlFragment,
  blockedUserSqlFragment,
    ...
    it.skip("filters down to active comments on in-network posts or followed posts", () => {
      ...
      expectEqualQuery(
        ...
        and (
          ...
          or ((
            "communities_posts"."community_id" in ${myCommunityIdsSqlFragment(
              myId
            )}
            or "communities_posts"."community_id" in ${myNetworkCommunityIdsSqlFragment(
              myId
            )}
          ))
        )`
