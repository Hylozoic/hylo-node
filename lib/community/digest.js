...
Digest.prototype.fetchData = function() {
  ...
  .spread(function(comments, commentedSeeds) {
    ...
    commentedSeeds.each(function(seed) {
      ...
      seed.comments.comparator = function(a, b) { return a.id - b.id };
      seed.comments.sort();
    });
...
Digest.prototype.seedAttributes = function(seed) {
  return {
    ...
    description: renderText(seed.get('description'), 300),
    url:         Frontend.Route.seed(seed, this.community) + '?ctt=digest_email'
  };
};
