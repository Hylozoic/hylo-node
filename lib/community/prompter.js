...
var Prompter = function (community, startTime, endTime, debug) {
...
Prompter.sendToUser = function (user, community) {
...
Prompter.sendToCommunity = function (communityId) {
...
Prompter.sendWeekly = function () {
  ...
  .then(communities => Promise.map(communities.models, community =>
      Prompter.sendToCommunity(community.get('id'))))
}
