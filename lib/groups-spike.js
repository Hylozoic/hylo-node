...
export async function updateGroupMemberships ({ model, parent, settings, selectColumns }) {
  const { targetTableName, foreignKey } = getRelatedData(model, parent)
...
async function makeGroupConnections ({ model, filter, childFk, childTableName, parentFk, parentTableName }) {
