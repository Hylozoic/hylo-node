  ...
  .then(() => {
    ...
    function setupStreams (data, resolve, reject) {
      ...
      try {
        ...
        // Open Office documents are packaged as zip files
        // and  getFileType is not properly identifying the
        // subtype of docx or xlsx, etc. So in the case of
        // fileType identifyikng a zip file type we fallback
        // to the mime-type and extension identifyincation based
        // upon filename.
        if (fileType.ext === 'zip') {
