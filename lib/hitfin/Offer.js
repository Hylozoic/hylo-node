...
module.exports = {
    ...
    acceptPartially: function(accessToken, offerId, numShares) {
        return new Promise((resolve, reject) => {
            const url = process.env.HITFIN_API_URL + 'api/securities/offers/accept/partial/' + offerId + '/' + numShares

            console.log("============================================================================")
            console.info("Offer.acceptPartially")
            console.info(url)
