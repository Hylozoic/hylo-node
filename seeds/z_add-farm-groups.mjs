...
import { sample, partition } from 'lodash'
import faker from 'faker'
// const { sample, partition } = require('lodash')
// const faker = require('faker')
import { sample as sampleDB, fakeUser, fakeGroupData } from './dummy/dummy.js'
// const { sample: sampleDB, fakeUser, fakeGroupData } = require('./dummy/dummy')
import {
  ANIMAL_LIST,
  CLIMATE_ZONES,
