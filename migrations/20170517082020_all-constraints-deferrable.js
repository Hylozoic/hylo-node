const constraints = [
  ...
  {
    table: "communities_tags",
    constraint: "communities_tags_owner_id_foreign",
  },
  ...
  { table: "posts", constraint: "post_parent_post_id_foreign" },
  {
    ...
    constraint: "user_connections_other_user_id_foreign",
  },
  { table: "user_connections", constraint: "user_connections_user_id_foreign" },
  {
    table: "user_external_data",
    constraint: "user_external_data_user_id_foreign",
  },
];
