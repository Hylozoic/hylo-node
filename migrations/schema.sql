...
CREATE TABLE community (
    ...
    network_id bigint,
    visibility text DEFAULT 'secret'::text,
    CONSTRAINT community_visibility_check CHECK ((visibility = ANY (ARRAY['public'::text, 'private'::text, 'secret'::text])))
);
...
--
-- Name: community_join_request; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: community_join_request_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE community_join_request_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: community_join_request_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE community_join_request_id_seq OWNED BY community_join_request.id;
...
ALTER TABLE ONLY community_join_request ALTER COLUMN id SET DEFAULT nextval('community_join_request_id_seq'::regclass);
...
--
-- Name: community_join_request_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY community_join_request
    ADD CONSTRAINT community_join_request_pkey PRIMARY KEY (id);


--
-- Name: community_join_request_user_id_community_id_unique; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY community_join_request
    ADD CONSTRAINT community_join_request_user_id_community_id_unique UNIQUE (user_id, community_id);
...
--
-- Name: community_join_request_community_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY community_join_request
    ADD CONSTRAINT community_join_request_community_id_foreign FOREIGN KEY (community_id) REFERENCES community(id);


--
-- Name: community_join_request_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY community_join_request
    ADD CONSTRAINT community_join_request_user_id_foreign FOREIGN KEY (user_id) REFERENCES users(id);
