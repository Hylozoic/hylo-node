...
exports.up = async function (knex, Promise) {
  ...
  console.log(
    ...
    await deactivateMembershipsByGroupDataType(DataType.COMMUNITY)
  );
  console.log(
    "Reconciling num_members in communities",
    await reconcileNumMembersInCommunities()
  );
};

exports.down = async function (knex, Promise) {
  await knex.raw(
    "delete from group_memberships where group_id in (select id from groups where group_data_type = 1)"
  );
